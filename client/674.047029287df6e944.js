...
function SignupComponent_mat_error_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](1, "Enter Valid Fullname");
  ...
  class SignupComponent {
    ...
    ngOnInit() {
      this.signUpForm = this.formBuilder.group({
        full_name: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.required]],
  ...
  SignupComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({
    ...
    template: function SignupComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵpureFunction1"](11, _c0, ctx.isSignUpFormSubmitted && (ctx.signUpFormVal["full_name"] == null ? null : ctx.signUpFormVal["full_name"].errors == null ? null : ctx.signUpFormVal["full_name"].errors.required)));
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵproperty"]("ngIf", ctx.signUpFormVal["full_name"] == null ? null : ctx.signUpFormVal["full_name"].errors == null ? null : ctx.signUpFormVal["full_name"].errors.required);
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](4);
...
let UserVerifyComponent = /*#__PURE__*/(() => {
    ...
    verifyUser(userToken) {
      if (userToken !== null && userToken !== undefined) {
        this.authService.VerifyUser(userToken).subscribe(response => {
          if (response && response.ReturnCode == 200 && response.err == 0) {
            const decodeData = this.authService.getDecodeAccessToken(response.Data[0].token); // response.Data[0]['Userdata'] = response.Data[0];
  ...
  UserVerifyComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
    ...
    decls: 6,
    vars: 1,
    consts: [[1, "btn_blue", 3, "disabled", "click"]],
    template: function UserVerifyComponent_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "div")(1, "p");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](2, "User Verify");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](3, "div")(4, "button", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function UserVerifyComponent_Template_button_click_4_listener() {
          return ctx.nextPage();
        });
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](5, "Next Page");
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]()()();
      }

      if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](4);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("disabled", !ctx.userVerify);
      }
    }
  });
